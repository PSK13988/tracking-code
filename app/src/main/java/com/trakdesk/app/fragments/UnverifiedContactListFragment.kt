...
class UnverifiedContactListFragment : BaseFragment(), View.OnClickListener,
    ...
    companion object {
        val TAG = UnverifiedContactListFragment::class.java.name

        fun newInstance(): UnverifiedContactListFragment {
            return UnverifiedContactListFragment()
        }
    }
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_unverified_contact_list, container, false)
    }
